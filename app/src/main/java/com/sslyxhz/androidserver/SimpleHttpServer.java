...
public class SimpleHttpServer extends NanoHTTPD{
    ...
    private Map<String, HttpHandler> handler = new LinkedHashMap<String, HttpHandler>();
    private Context mContext;
    private String mRootDocumentPath;
    
    public SimpleHttpServer(int port, String rootDocumentPath, Context context){
        super(port);
    ...
    public Response serve(IHTTPSession session) {
        ...
        while (keyIterator.hasNext()) {
            ...
            if (uri.startsWith(key)) {
                HttpHandler handler = this.handler.get(key);
        ...
        return HttpHandler.notFoundResponse(); //no handler handled this uri
    }
